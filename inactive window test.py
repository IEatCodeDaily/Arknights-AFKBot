...
hwndMain = win32gui.FindWindow(None,"Arknights - MuMu App Player")
...
while(True):
    ...
    win32api.PostMessage(hwndChild,win32con.WM_KEYDOWN,0x10,0)
    time.sleep(.5)
    win32api.PostMessage(hwndChild,win32con.WM_KEYUP,0x10,0)
